<x-admin-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <p><strong>Actual:</strong> {{ $poseaReciente->valor }} </p>
                    </div>
    ...
    <script id="graficoPoseaData" type="application/json">
        @json($poseaChartData)
    </script>
    <script>
        const ctx = document.getElementById('graficoposea').getContext('2d');
        const poseaChartData = JSON.parse(document.getElementById('graficoPoseaData').textContent);
        const labels = poseaChartData.labels ?? [];
        const data = poseaChartData.values ?? [];
