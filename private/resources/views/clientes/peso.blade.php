<x-admin-layout>
    ...
    <script id="graficoPesoData" type="application/json">
        @json($pesoChartData)
    </script>
    <script>
        const ctx = document.getElementById('graficoPeso').getContext('2d');
        const pesoChartData = JSON.parse(document.getElementById('graficoPesoData').textContent);
        const labels = pesoChartData.labels ?? [];
        const data = pesoChartData.values ?? [];
