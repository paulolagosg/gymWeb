                ...
                <form action="{{ route('gimnasios.update', $gimnasio->slug) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="color" id="color_primario" name="color_primario" value="{{ old('color_primario', $gimnasio->color_primario ?? '#489ddf') }}" class="mt-1 block h-11 w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
                        ...
                        <div>
                            ...
                            <input type="color" id="color_secundario" name="color_secundario" value="{{ old('color_secundario', $gimnasio->color_secundario ?? '#3f8ac4') }}" class="mt-1 block h-11 w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
                        ...
                        <div>
                            ...
                            <input type="text" id="email_encabezado" name="email_encabezado" value="{{ old('email_encabezado', $gimnasio->email_encabezado) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3" placeholder="Ej: Bienvenido a Fit Norte">
                        ...
                        <div>
                            ...
                            <input type="text" id="email_firma" name="email_firma" value="{{ old('email_firma', $gimnasio->email_firma) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3" placeholder="Ej: Equipo Fit Norte">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="email_pie" name="email_pie" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3" placeholder="Teléfono, dirección, sitio web o mensaje institucional">{{ old('email_pie', $gimnasio->email_pie) }}</textarea>
