            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('ejercicios.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="nombre" class="block text-gray-700">Nombre del Ejercicio</label>
                        ...
                        <div class="mb-4">
                            <label for="descripcion" class="block text-gray-700">Descripción del Ejercicio</label>
                        ...
                        <div class="mb-4">
                            <label for="id_tipo" class="block text-gray-700">Tipo de Ejercicio</label>
