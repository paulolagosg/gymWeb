        ...
        <div class="">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 flex justify-between text-end">
                    <a href="{{ route('planes.create') }}" class="bg-gray-700 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded">
                        Agregar Plan
                    </a>
                </div>
                    ...
                    <table id="tablaDatos" class="display w-full min-w-max">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="bg-gray-800 hover:bg-gray-500 text-white font-bold py-1 px-2 rounded" onclick="location.href='{{ route('planes.edit', $plan->slug) }}'">
                                        Editar
                                    </button>
