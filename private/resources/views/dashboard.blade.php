...
<x-admin-layout>
    <div class="py-4">
        <div class="max-w-7xl mx-auto">
            @if(($esSuperAdmin ?? false) && isset($gimnasios))
            <div class="mb-6 flex justify-end">
                <form method="GET" class="flex items-center gap-2 rounded-lg bg-white px-4 py-3 shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-8">
                ...
                <div class="p-6 rounded-lg shadow  border-t-4" style="background-color: #63D5F8;border-top-color: #099BC8;">
                    ...
                    <table class="w-full">
                        ...
                        <tr>
                            <td class="text-white text-left">{{ $rango }}</td>
                            <td>&nbsp;</td>
                            <th class="text-white text-left font-bold"">{{ $cantidad }}</th></tr>
                        @endforeach
                    </table>
                    <!--div class=" flex justify-center">
                ...
                <div class="bg-green-100 p-6 rounded-lg shadow text-center border-t-4 border-green-500">
                    ...
                    <table class="w-full">
                        ...
                        <tr>
                            <td style="text-align:left">{{ $m->motivo }}</td>
                            <td>&nbsp;</td>
                            <th style="text-align:right">{{ $m->cantidad }}</th>
                        </tr>
                        @endforeach
                    </table>
                </div>
    ...
    <script>
        ...
        const ingresosMeses = @json($ingresosMesesChart);
        const ingresosTotales = @json($ingresosTotalesChart);
        const ingresosProyectados = @json($ingresosProyectadosChart);
        ...
        const formasPagoNombres = @json($formasPagoNombresChart);
        const formasPagoDatasets = @json($formasPagoDatasetsChart);
        ...
        const picosLabels = @json($picosLabelsChart);
        const picosData = @json($picosDataChart);
        ...
        const nombrePlanLabels = @json($nombrePlanLabelsChart);
        const nombrePlanData = @json($nombrePlanDataChart);
        ...
        const chart = new Chart(cpe, {
            type: 'bar',
            data: {
                labels: @json($mesesClientesChart),
                datasets: @json($datasetsClientesPorEntrenadorChart)
            },
            options: {
                responsive: true,
                maintainAspectRatio: false,
